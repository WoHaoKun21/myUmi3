...
import { a as P } from './chunk-Z7BLUZ7R.js';
import { a as j, b as d } from './chunk-PY4CW263.js';
import { a as O } from './chunk-RRZIPF5C.js';
import { a as A, b as m, g as u } from './chunk-M3A6SPGI.js';
import { a as e, c as l, d as _ } from './chunk-S4VBGY2U.js';
import { a as g } from './chunk-N3A5CZ2S.js';
import { a as y, b as p } from './chunk-G75U3WZT.js';
...
function s(n, t) {
  ...
  let o = u.eastNorthUpToFixedFrame(n, t);
  (this._ellipsoid = t),
    (this._origin = n),
    (this._xAxis = e.fromCartesian4(m.getColumn(o, 0, x))),
    (this._yAxis = e.fromCartesian4(m.getColumn(o, 1, x)));
  let i = e.fromCartesian4(m.getColumn(o, 2, x));
  this._plane = O.fromPointNormal(n, i);
}
...
s.prototype.projectPointOntoPlane = function (n, t) {
  ...
  let i = d.rayPlane(o, this._plane, h);
  if (
    (r(i) ||
      (e.negate(o.direction, o.direction), (i = d.rayPlane(o, this._plane, h))),
    r(i))
  ) {
