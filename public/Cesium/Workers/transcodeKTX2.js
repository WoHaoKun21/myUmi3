...
import { a as rn } from './chunk-4BYMTYMT.js';
import { a as M } from './chunk-54PMPXZ4.js';
import { a as ie } from './chunk-R62IKKEC.js';
import { a as _n } from './chunk-N3A5CZ2S.js';
import { b as nn } from './chunk-G75U3WZT.js';
import { a as Gt, c as sr, d as or, e as ge } from './chunk-3THTQ4QB.js';
var Rn = sr((it, pt) => {
  var Nt = (function () {
    var i =
      ...
      function (f) {
        ...
        p
          ...
          ? (typeof read < 'u' &&
            ...
            typeof scriptArgs < 'u'
              ? (U = scriptArgs)
              : typeof arguments < 'u' && (U = arguments),
        ...
        function He(e, t, n) {
          ...
          for (var a = ''; t < s; ) {
            ...
            var o = e[t++] & 63;
            if ((c & 224) == 192) {
              a += String.fromCharCode(((c & 31) << 6) | o);
              continue;
            }
            var R = e[t++] & 63;
            if (
        ...
        function Rt(e, t, n, _) {
          if (!(_ > 0)) return 0;
          for (var s = n, a = n + _ - 1, c = 0; c < e.length; ++c) {
        ...
        function at(e, t) {
          ...
          if (((n = _ << 1), n - e > 32 && Ae))
            return Ae.decode(D.subarray(e, n));
          for (var a = '', c = 0; !(c >= t / 2); ++c) {
            var o = fe[(e + c * 2) >> 1];
            if (o == 0) break;
        ...
        function xe(e, t, n) {
          ...
          n -= 2;
          for (
            var _ = t, s = n < e.length * 2 ? n / 2 : e.length, a = 0;
            a < s;
            ++a
          ) {
        ...
        function Un() {
          ...
          function s() {
            return !ae &&
              ...
              ? fetch(x, { credentials: 'same-origin' }).then(function (c) {
                  var o = WebAssembly.instantiateStreaming(c, e);
          ...
          if (r.instantiateWasm)
            try {
              ...
              return (
                ee('Module.instantiateWasm callback failed with error: ' + c),
                !1
              );
            }
          return s().catch(l), {};
...
` +
        ...
        function Ln(e) {
          ...
          var n = t.rawConstructor,
            ...
            a = s
              .map(function (c) {
                return c.getterReturnType;
              })
              .concat(
                s.map(function (c) {
                  return c.setterArgumentType;
                }),
              );
          oe([e], a, function (c) {
            var o = {};
        ...
        function q(e, t, n) {
          ...
          if (
            (e ||
              S('type "' + _ + '" must have a positive integer typeid pointer'),
            ue.hasOwnProperty(e))
          ) {
          ...
          (t = v(t)),
            q(e, {
              ...
              readValueFromPointer: function (c) {
                ...
                return this.fromWireType(o[c >> a]);
              },
        ...
        function zn(e, t) {
          ...
          if (
            ((n = Mt(t.$$.ptr, _, this.registeredClass)), this.isSmartPointer)
          )
            switch (
              (t.$$.smartPtr === void 0 &&
        ...
        function Je(e, t) {
          (!t.ptrType || !t.ptr) &&
            Ze('makeClassHandle requires ptr and ptrType');
        ...
        function te(e, t, n, _, s, a, c, o, R, T, O) {
          (this.name = e),
        ...
        function z(e, t) {
          ...
          return (
            typeof _ != 'function' &&
              S('unknown function pointer with signature ' + e + ': ' + t),
            _
          );
        }
        var Wt = void 0;
        ...
        function c_(e, t, n, _, s, a, c, o, R, T, O, K, G) {
          (O = v(O)),
            (a = z(s, a)),
            o && (o = z(c, o)),
            T && (T = z(R, T)),
          ...
          lt(N, function () {
            ...
            oe([e, t, n], _ ? [_] : [], function (h) {
              ...
              var I, $;
              _
                ? ((I = h.registeredClass), ($ = I.instancePrototype))
                : ($ = Re.prototype);
              var Z = qe(N, function () {
                  if (Object.getPrototypeOf(this) !== ye)
                    throw new Be("Use 'new' to construct " + O);
              ...
              return (
                (Xt[e] = { pointerType: Jt, constPointerType: en }),
                $t(N, Z),
                [ir, Jt, en]
              );
            });
        ...
        function A_(e, t, n, _, s, a) {
          ...
          oe([], [e], function (T) {
            ...
            if (
              (T.registeredClass.constructor_body === void 0 &&
            ...
            return (
              (T.registeredClass.constructor_body[t - 1] = function () {
                et('Cannot construct ' + T.name + ' due to unbound types', c);
              }),
              oe([], c, function (K) {
                return (
                  (T.registeredClass.constructor_body[t - 1] = function () {
                    arguments.length !== t - 1 &&
                      ...
                      (o.length = t);
                    for (var N = 1; N < t; ++N)
                      o[N] = K[N].toWireType(R, arguments[N - 1]);
...
`),
            ...
            q(e, {
              ...
              toWireType: function (s, a) {
                if (typeof a != 'number' && typeof a != 'boolean')
                  throw new TypeError(
                    'Cannot convert "' + Ce(a) + '" to ' + this.name,
                  );
                return a;
              },
              argPackAdvance: 8,
        ...
        function S_(e, t, n, _, s, a) {
          ...
          (e = v(e)),
            ...
            lt(
              e,
              function () {
                et('Cannot call ' + e + ' due to unbound types', c);
              },
              t - 1,
            ),
            oe([], c, function (o) {
          ...
          q(e, {
            ...
            fromWireType: function (_) {
              var s = Y[_ >> 2],
                a;
              if (n)
                for (var c = _ + 4, o = 0; o <= s; ++o) {
                  var R = _ + 4 + o;
                  if (o == s || D[R] == 0) {
                    var T = R - c,
                      O = Xe(c, T);
                    a === void 0 ? (a = O) : ((a += '\0'), (a += O)),
                      (c = R + 1);
                  }
                }
              else {
                for (var K = new Array(s), o = 0; o < s; ++o)
                  K[o] = String.fromCharCode(D[_ + 4 + o]);
                a = K.join('');
              }
              return _e(_), a;
            },
        ...
        function P_(e, t, n) {
          ...
          t === 2
            ...
            q(e, {
              ...
              toWireType: function (R, T) {
                typeof T != 'string' &&
                  S('Cannot pass non-string to C++ string type ' + n);
                var O = c(T),
                  K = dt(4 + O + t);
                return (
                  (Y[K >> 2] = O >> o),
        ...
        function v_(e, t, n, _, s, a, c, o, R, T) {
          We[e].fields.push({
            fieldName: v(t),
            getterReturnType: n,
            getter: z(_, s),
...
`),
            a.push(O);
          var G = zt(Function, a).apply(null, c);
          return m_(G);
        }
        function b_(e) {
...
`),
        ...
        function z_(e) {
          try {
            return (
              ce.grow((e - ct.byteLength + 65535) >>> 16), vt(ce.buffer), 1
            );
          } catch {}
        }
        function Y_(e) {
        ...
        function Q_(e, t, n, _) {
          for (var s = 0, a = 0; a < n; a++) {
            for (
              var c = w[(t + a * 8) >> 2], o = w[(t + (a * 8 + 4)) >> 2], R = 0;
              R < o;
              R++
            )
              _t.printChar(e, D[c + R]);
            s += o;
          }
          return (w[_ >> 2] = s), 0;
        }
        ...
        var er = {
          ...
          nr = (r.___embind_register_native_and_builtin_types = function () {
            return (nr = r.___embind_register_native_and_builtin_types =
...
A.componentsLength = function (i) {
  switch (i) {
    case A.RGB:
      return 3;
    case A.RGBA:
      return 4;
    case A.LUMINANCE_ALPHA:
    case A.RG:
      return 2;
    case A.ALPHA:
    case A.RED:
...
A.validate = function (i) {
  return (
    ...
    i === A.RGBA_DXT3 ||
    i === A.RGBA_DXT5 ||
    i === A.RGB_PVRTC_4BPPV1 ||
    i === A.RGB_PVRTC_2BPPV1 ||
    i === A.RGBA_PVRTC_4BPPV1 ||
    i === A.RGBA_PVRTC_2BPPV1 ||
    i === A.RGBA_ASTC ||
    i === A.RGB_ETC1 ||
    i === A.RGB8_ETC2 ||
    i === A.RGBA8_ETC2_EAC ||
...
A.isDepthFormat = function (i) {
  return i === A.DEPTH_COMPONENT || i === A.DEPTH_STENCIL;
};
A.isCompressedFormat = function (i) {
  return (
    i === A.RGB_DXT1 ||
    i === A.RGBA_DXT1 ||
    i === A.RGBA_DXT3 ||
...
A.isASTCFormat = function (i) {
  return i === A.RGBA_ASTC;
};
A.isETC1Format = function (i) {
  return i === A.RGB_ETC1;
};
A.isETC2Format = function (i) {
  return i === A.RGB8_ETC2 || i === A.RGBA8_ETC2_EAC;
};
A.isBC7Format = function (i) {
  return i === A.RGBA_BC7;
};
A.compressedTextureSizeInBytes = function (i, f, r) {
  switch (i) {
    case A.RGB_DXT1:
    case A.RGBA_DXT1:
    case A.RGB_ETC1:
    ...
    case A.RGBA_DXT5:
    case A.RGBA_ASTC:
    case A.RGBA8_ETC2_EAC:
      return Math.floor((f + 3) / 4) * Math.floor((r + 3) / 4) * 16;
    case A.RGB_PVRTC_4BPPV1:
    case A.RGBA_PVRTC_4BPPV1:
      return Math.floor((Math.max(f, 8) * Math.max(r, 8) * 4 + 7) / 8);
    case A.RGB_PVRTC_2BPPV1:
    case A.RGBA_PVRTC_2BPPV1:
...
A.textureSizeInBytes = function (i, f, r, C) {
  let l = A.componentsLength(i);
  return H.isPacked(f) && (l = 1), l * H.sizeInBytes(f) * r * C;
};
A.alignmentInBytes = function (i, f, r) {
  let C = A.textureSizeInBytes(i, f, r, 1) % 4;
  return C === 0 ? 4 : C === 2 ? 2 : 1;
};
A.createTypedArray = function (i, f, r, C) {
  let l = H.getTypedArrayConstructor(f),
    P = A.componentsLength(i) * r * C;
  return new l(P);
};
A.flipY = function (i, f, r, C, l) {
  if (l === 1) return i;
  let P = A.createTypedArray(f, r, C, l),
    F = A.componentsLength(f),
    U = C * F;
  for (let y = 0; y < l; ++y) {
    let m = y * C * F,
      V = (l - y - 1) * C * F;
...
A.toInternalFormat = function (i, f, r) {
  if (!r.webgl2) return i;
  if (i === A.DEPTH_STENCIL) return M.DEPTH24_STENCIL8;
  if (i === A.DEPTH_COMPONENT) {
...
var Vt = class {
  ...
  Oe = class {
    ...
    _scan(f, r = 0) {
      let C = this._offset,
        l = 0;
      for (; this._dataView.getUint8(this._offset) !== r && l < f; )
        l++, this._offset++;
      return (
        l < f && this._offset++,
        new Uint8Array(this._dataView.buffer, this._dataView.byteOffset + C, l)
      );
    }
  };
...
function on(i) {
  ...
  for (; J._offset < m; ) {
    let L = J._nextUint32(),
      ...
      Ae = sn(j);
    if (
      ((r.keyValue[Ae] = J._nextUint8Array(L - j.byteLength - 1)),
      Ae.match(/^ktx/i))
    ) {
...
function ar(i, f) {
  ...
  if (l.layerCount !== 0)
    throw new ie('KTX2 texture arrays are not supported.');
...
function Ar(i, f, r, C, l, P) {
  let F = new C.KTX2File(i),
    ...
    V = F.getHasAlpha();
  if (!(U > 0) || !(y > 0) || !(m > 0))
    throw (F.close(), F.delete(), new ie('Invalid KTX2 file'));
  let d,
    p,
  ...
  if (Q.colorModel === An)
    if (r.etc)
      (d = V ? E.RGBA8_ETC2_EAC : E.RGB8_ETC2),
        (p = V ? u.cTFETC2_RGBA : u.cTFETC1_RGB);
    else if (r.etc1 && !V) (d = E.RGB_ETC1), (p = u.cTFETC1_RGB);
    else if (r.s3tc)
      (d = V ? E.RGBA_DXT5 : E.RGB_DXT1),
        (p = V ? u.cTFBC3_RGBA : u.cTFBC1_RGB);
    else if (r.pvrtc)
      (d = V ? E.RGBA_PVRTC_4BPPV1 : E.RGB_PVRTC_4BPPV1),
        (p = V ? u.cTFPVRTC1_4_RGBA : u.cTFPVRTC1_4_RGB);
  ...
  if (!F.startTranscoding())
    throw (F.close(), F.delete(), new ie('startTranscoding() failed'));
  for (let X = 0; X < f.levels.length; ++X) {
    ...
    l.push(W.buffer),
      (se[cn[0]] = { internalFormat: d, width: U, height: y, levelBuffer: W });
  }
...
async function fr(i, f) {
  ...
  return (
    ge(r.wasmBinaryFile) ? (me = await C(r)) : (me = await C()),
    me.initializeBasis(),
    !0
  );
}
