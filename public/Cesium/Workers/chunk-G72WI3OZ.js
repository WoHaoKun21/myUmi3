...
import { a as _ } from './chunk-RNF7TLFF.js';
import { a as te } from './chunk-CTRWX4F5.js';
import { a as fe, b as j, f as Z, g as me } from './chunk-M3A6SPGI.js';
import { a as e, b as ie, c as ee, e as O } from './chunk-S4VBGY2U.js';
import { a as Q } from './chunk-UCTPWOTZ.js';
import { a as se } from './chunk-N3A5CZ2S.js';
import { a as le } from './chunk-G75U3WZT.js';
...
function v(r, n, a, o, t, c, f, l) {
  ...
  (oe = O.fromRotationZ(S, oe)),
    (de.z = c),
    (H = j.multiplyTransformation(H, j.fromRotationTranslation(oe, de, Ve), H));
  let d = Ne;
  d[0] = f;
  for (let x = 0; x < l; x++)
