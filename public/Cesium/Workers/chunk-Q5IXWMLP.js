...
import { a as E } from './chunk-6HIVPZ7K.js';
import { a as Q } from './chunk-RRZIPF5C.js';
import { a as ae } from './chunk-24JYWT5N.js';
import { b as oe, c as re, d as J } from './chunk-LH3SUUXG.js';
import { b as A, d as ie } from './chunk-K2M3OJ7Z.js';
import { a as b, b as F, f as N } from './chunk-M3A6SPGI.js';
import { a as H } from './chunk-D5HNP2LB.js';
import { a as r, e as G } from './chunk-S4VBGY2U.js';
import { a as P } from './chunk-UCTPWOTZ.js';
import { a as m } from './chunk-N3A5CZ2S.js';
import { a as w, b as O } from './chunk-G75U3WZT.js';
import { e as a } from './chunk-3THTQ4QB.js';
function T(e) {
  this.planes = m(e, []);
}
...
T.fromBoundingSphere = function (e, t) {
  ...
  for (let y = 0; y < n; ++y) {
    ...
    a(c) || (c = f[s] = new b()),
      ...
      (_.y = -i.y),
      (_.z = -i.z),
      (_.w = -r.dot(r.negate(i, _e), V)),
      (s += 2);
  }
  return t;
};
T.prototype.computeVisibility = function (e) {
  if (!a(e)) throw new w('boundingVolume is required.');
  let t = this.planes,
    n = !1;
  for (let f = 0, p = t.length; f < p; ++f) {
    let d = e.intersectPlane(Q.fromCartesian4(t[f], fe));
    if (d === A.OUTSIDE) return A.OUTSIDE;
    d === A.INTERSECTING && (n = !0);
  }
  return n ? A.INTERSECTING : A.INSIDE;
};
T.prototype.computeVisibilityWithPlaneMask = function (e, t) {
  if (!a(e)) throw new w('boundingVolume is required.');
  if (!a(t)) throw new w('parentPlaneMask is required.');
  if (t === T.MASK_OUTSIDE || t === T.MASK_INSIDE) return t;
  let n = T.MASK_INSIDE,
    f = this.planes;
  for (let p = 0, d = f.length; p < d; ++p) {
    ...
    if (y === A.OUTSIDE) return T.MASK_OUTSIDE;
    y === A.INTERSECTING && (n |= s);
  }
  return n;
};
T.MASK_OUTSIDE = 4294967295;
T.MASK_INSIDE = 0;
T.MASK_INDETERMINATE = 2147483647;
var $ = T;
function k(e) {
...
k.prototype.computeCullingVolume = function (e, t, n) {
  ...
  let l = ge;
  r.multiplyByScalar(_, y, l), r.add(g, l, l);
  let o = f[0];
  return (
    a(o) || (o = f[0] = new b()),
    (o.x = _.x),
    ...
    (o.y = -_.y),
    (o.z = -_.z),
    (o.w = -r.dot(r.negate(_, ee), l)),
    r.multiplyByScalar(n, d, l),
    r.add(g, l, l),
    (o = f[2]),
    a(o) || (o = f[2] = new b()),
    (o.x = n.x),
...
z.prototype.computeCullingVolume = function (e, t, n) {
  return j(this), this._offCenterFrustum.computeCullingVolume(e, t, n);
};
z.prototype.getPixelDimensions = function (e, t, n, f, p) {
...
z.prototype.equalsEpsilon = function (e, t, n) {
  return !a(e) || !(e instanceof z)
    ? !1
    : (j(this),
      j(e),
...
function te(e) {
  ...
  let { top: t, bottom: n, right: f, left: p, near: d, far: s } = e;
  if (
    t !== e._top ||
    n !== e._bottom ||
    p !== e._left ||
...
function q(e) {
  ...
  if (
    ...
    return;
  if (
    (O.typeOf.number.greaterThanOrEquals('fov', e.fov, 0),
    O.typeOf.number.lessThan('fov', e.fov, Math.PI),
    O.typeOf.number.greaterThanOrEquals('aspectRatio', e.aspectRatio, 0),
    O.typeOf.number.greaterThanOrEquals('near', e.near, 0),
    e.near > e.far)
  )
...
Object.defineProperties(R.prototype, {
  projectionMatrix: {
    get: function () {
      return q(this), this._offCenterFrustum.projectionMatrix;
    },
  },
  infiniteProjectionMatrix: {
    get: function () {
  ...
  offCenterFrustum: {
    get: function () {
      return q(this), this._offCenterFrustum;
    },
  },
});
R.prototype.computeCullingVolume = function (e, t, n) {
  return q(this), this._offCenterFrustum.computeCullingVolume(e, t, n);
};
R.prototype.getPixelDimensions = function (e, t, n, f, p) {
  return q(this), this._offCenterFrustum.getPixelDimensions(e, t, n, f, p);
};
...
function U(e) {
  O.typeOf.object('options', e),
    O.typeOf.object('options.frustum', e.frustum),
    O.typeOf.object('options.origin', e.origin),
    O.typeOf.object('options.orientation', e.orientation);
  let t = e.frustum,
    n = e.orientation,
    f = e.origin,
    p = m(e.vertexFormat, E.DEFAULT),
    d = m(e._drawNearPlane, !0),
    s,
    y;
  t instanceof L
    ...
    (this.packedLength =
      2 + y + r.packedLength + N.packedLength + E.packedLength);
}
U.pack = function (e, t, n) {
  O.typeOf.object('value', e), O.defined('array', t), (n = m(n, 0));
...
U.unpack = function (e, t, n) {
  O.defined('array', e), (t = m(t, 0));
  let f = e[t++],
    p;
  f === I
    ? ((p = L.unpack(e, t, xe)), (t += L.packedLength))
    : ((p = B.unpack(e, t, ve)), (t += B.packedLength));
  let d = r.unpack(e, t, Re);
  t += r.packedLength;
  let s = N.unpack(e, t, ze);
  t += N.packedLength;
  let y = E.unpack(e, t, Te);
  t += E.packedLength;
  let i = e[t] === 1;
  if (!a(n))
    return new U({
  ...
  return (
    ...
    (n._frustumType = f),
    (n._origin = r.clone(d, n._origin)),
    (n._orientation = N.clone(s, n._orientation)),
    (n._vertexFormat = E.clone(y, n._vertexFormat)),
    (n._drawNearPlane = i),
    n
  );
};
function W(e, t, n, f, p, d, s, y) {
  let i = (e / 3) * 2;
  for (let c = 0; c < 4; ++c)
    a(t) && ((t[e] = d.x), (t[e + 1] = d.y), (t[e + 2] = d.z)),
...
Z[3] = new b(-1, 1, 1, 1);
var de = new Array(4);
for (let e = 0; e < 4; ++e) de[e] = new b();
U._computeNearFarPlanes = function (e, t, n, f, p, d, s, y) {
  ...
  (c = G.getColumn(i, 0, c)),
    ...
    r.normalize(g, g),
    r.negate(c, c);
  let l = F.computeView(e, g, _, c, Me),
    o,
    h,
    M = f.projectionMatrix;
  if (n === I) {
    let x = F.multiply(M, l, ne);
    h = F.inverse(x, ne);
  ...
  for (let x = 0; x < 2; ++x)
    for (let v = 0; v < 4; ++v) {
      let C = b.clone(Z[v], de[v]);
      if (a(h)) {
        C = F.multiplyByVector(h, C, C);
        let D = 1 / C.w;
        r.multiplyByScalar(C, D, C), r.subtract(C, e, C), r.normalize(C, C);
        let Y = r.dot(g, C);
        r.multiplyByScalar(C, u[x] / Y, C), r.add(C, e, C);
      } else {
...
U.createGeometry = function (e) {
  ...
  U._computeNearFarPlanes(f, p, t, n, i);
  let c = 3 * 4 * 2;
  (i[c] = i[3 * 4]),
    (i[c + 1] = i[3 * 4 + 1]),
    (i[c + 2] = i[3 * 4 + 2]),
