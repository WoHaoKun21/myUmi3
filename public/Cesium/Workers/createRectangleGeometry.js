...
import { a as J } from './chunk-Z6PJ3IIE.js';
import { a as Nt } from './chunk-W5MIOKEY.js';
import { a as zt } from './chunk-72CGGEJF.js';
import './chunk-Q5MYX5A2.js';
import './chunk-OZYLWM74.js';
import { a as ut } from './chunk-5CC3QRYS.js';
import { a as X } from './chunk-6HIVPZ7K.js';
import { b as Rt } from './chunk-WJYW7YDO.js';
import './chunk-RDAVO5OM.js';
import './chunk-PY4CW263.js';
import './chunk-RRZIPF5C.js';
import { a as yt } from './chunk-34ULWVZF.js';
import { a as Vt } from './chunk-24JYWT5N.js';
import { b as Mt, c as Pt, d as q } from './chunk-LH3SUUXG.js';
import { d as st } from './chunk-K2M3OJ7Z.js';
import { f as Lt, h as E, i as At } from './chunk-M3A6SPGI.js';
import { a as Y } from './chunk-D5HNP2LB.js';
import { a as w, b as _t, c as G, d as H, e as ft } from './chunk-S4VBGY2U.js';
import { a as W } from './chunk-UCTPWOTZ.js';
import './chunk-54PMPXZ4.js';
import './chunk-R62IKKEC.js';
import { a as L } from './chunk-N3A5CZ2S.js';
import { a as St, b as lt } from './chunk-G75U3WZT.js';
import { e as $ } from './chunk-3THTQ4QB.js';
var Tt = new w(),
  Bt = new w(),
  Ut = new w(),
  Yt = new w(),
    ...
    for (let f = 0; f < a; f += 3) {
      ...
      (i = n.geodeticSurfaceNormal(s, i)),
        (e.tangent || e.bitangent) &&
          ...
          w.normalize(o, o),
          e.bitangent && w.normalize(w.cross(i, o, p), p)),
...
function te(t, e, n) {
  ...
  if (e.normal || e.tangent || e.bitangent)
    for (let h = 0; h < r; h += 6) {
      ...
      w.equalsEpsilon(A, g, W.EPSILON10) && (o = !0),
        (e.tangent || e.bitangent) &&
...
function ee(t, e) {
  ...
  for (o = 0; o < s - 1; o += 2) {
    (mt = o), (bt = (mt + 2) % s);
    let R = w.fromArray(C, mt * 3, Ct),
      at = w.fromArray(C, bt * 3, jt);
    w.equalsEpsilon(R, at, W.EPSILON10) ||
      ((wt = (mt + 1) % s),
      (kt = (wt + 2) % s),
      (it[ct++] = mt),
      (it[ct++] = wt),
...
function Q(t) {
  ...
  let e = t.rectangle;
  if ((lt.typeOf.object('rectangle', e), E._validate(e), e.north < e.south))
    throw new St(
...
Q.computeRectangle = function (t, e) {
  t = L(t, L.EMPTY_OBJECT);
  let n = t.rectangle;
  if ((lt.typeOf.object('rectangle', n), E._validate(n), n.north < n.south))
    throw new St(
      'options.rectangle.north must be greater than or equal to options.rectangle.south',
    );
