    ...
    return (
      ...
      function (e) {
        ...
        function n(t, e, r) {
          var n = e + r;
          for (r = e; t[r] && !(r >= n); ) ++r;
          if (16 < r - e && t.subarray && ot)
            return ot.decode(t.subarray(e, r));
          for (n = ''; e < r; ) {
            var o = t[e++];
            if (128 & o) {
              var _ = 63 & t[e++];
        ...
        if (k) {
          ...
          1 < process.argv.length && (Q = process.argv[1].replace(/\\/g, '/')),
        ...
        (B = null),
          w.thisProgram && (Q = w.thisProgram),
          w.wasmBinary && (X = w.wasmBinary),
          'object' != typeof WebAssembly &&
            tt('no native wasm support detected');
        var et,
        ...
        u(ht) ||
          ((At = ht), (ht = w.locateFile ? w.locateFile(At, Y) : Y + At)),
          st.push({
            func: function () {
              Gt();
            },
                ...
                X || (!$ && !W) || 'function' != typeof fetch
                  ...
                  : fetch(ht, { credentials: 'same-origin' })
                      .then(function (t) {
                        if (!t.ok)
                          throw (
                            "failed to load wasm binary file at '" + ht + "'"
                          );
        ...
        var Gt = (w.___wasm_call_ctors = function () {
          ...
          Mt = (w._emscripten_bind_DracoUInt16Array___destroy___0 =
            function () {
          ...
          Yt = (w._emscripten_bind_PointAttribute_PointAttribute_0 =
            function () {
          ...
          fe =
            (w._emscripten_bind_AttributeQuantizationTransform___destroy___0 =
              function () {
          ...
          Ee = (w._emscripten_bind_MetadataQuerier_GetEntryName_2 =
            function () {
          ...
          Be = (w._emscripten_bind_Decoder_Decoder_0 = function () {
            return w.asm.emscripten_bind_Decoder_Decoder_0.apply(
              null,
              arguments,
            );
          }),
          ...
          Ze = (w._emscripten_bind_Decoder_GetAttributeMetadata_2 =
            function () {
          ...
          mr = (w._emscripten_bind_Mesh_num_faces_0 = function () {
            return w.asm.emscripten_bind_Mesh_num_faces_0.apply(
              null,
              arguments,
            );
          }),
          ...
          br = (w._emscripten_bind_Mesh_num_points_0 = function () {
            return w.asm.emscripten_bind_Mesh_num_points_0.apply(
              null,
              arguments,
            );
          }),
        ...
        return (
          ...
          (S.prototype.Init = S.prototype.Init =
            function (t, e) {
              var r = this.ptr;
              if (
                (an.prepare(), 'object' == typeof t && 'object' == typeof t)
              ) {
                var n = an.alloc(t, _t);
                an.copy(t, _t, n), (t = n);
              }
